			  ...
			  <div class="row">
				...
				<div class="col-md-3">
				  <div class="ms-md-auto">
					<form class="input-group input-group-outline" id="searchForm" method="post">
					  <label class="form-label"></label>
					  <input type="text" class="form-control" name="searchWord" value="${searchWord }">
					  <input type="hidden" name="page" id="page" />
					  <input type="hidden" name="searchType" id="sType" />
					</form>
				  </div>
				</div>
				<div class="col-md-2">
				  <button type="button" class="btn btn-outline-secondary" id="searchBtn">검색</button>
				  <button type="button" class="btn btn-outline-secondary" id="insertBtn">등록</button>
				</div>
			  </div>
			</div>
            <div class="card-body px-0 pb-2">
                  	...
                  	<c:choose>
                  		...
                  		<c:otherwise>
                  			<c:forEach items="${boardList }" var="board">
			                    <tr class="text-center viewBtn" id="${board.bono }">
			                      <td>${board.bono }</td>
