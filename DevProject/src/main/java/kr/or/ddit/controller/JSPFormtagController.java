...
public class JSPFormtagController {
	 ...
	 * 		** 생성 시, 사용하게될 속성들이 어떤것이 있고 설정 정보에는 어떤것이 있는지 체크해봅시다.
	 * 
	 * 3. 폼 항목의 공통 속성
	...
	// 규칙성있는 자바빈즈 객체가 해당 매개변수 칸에 있으면 변수 명이 아니라 Member 객체명을 전달자로 가져가는데 앞에 대문자를 소문자로 바꿔서 간다.
	public String registerForm03(Member member) { 
		log.info("reigterForm03() 실행...!");
		return "home/formtag/registerForm01";
	}
