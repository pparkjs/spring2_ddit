...
public class JSTLHomeController {
	 ...
	 * 		<c:param>		|	파라미터를 지정한다.
	 * 	
	 * 		[ tablib 지시자 사용 ::: <%@ taglib uri="http://java.sun.com/jstl/core" prefix="c" %>] 
	 * 
	 * 		2) fmt태그 라이브러리
	 * 
	 * 			요소					|	설명
	 ...
	 * 		
	 * 		[ tablib 지시자 사용 ::: <%@ taglib uri="http://java.sun.com/jstl/fmt" prefix="fmt" %>] 		
	 * 
	 * 		3) function 태그 라이브러리
	 * 		
	 * 			요소					|	설명
	 ...
	 * 		<fn:length>				|	컬렉션 또는 배열의 요소 개수, 문자열 길이를구한다.
	 ...
	 * 	
	 * 		[taglib 지시자 사용 ::: <%@ taglib uri="http://java.sun.com/jstl/function" prefix="fn" %>] 	
	 * 
	 * 6. 코어 태그
	 ...
	 * 		value		|	Object		|	출력할 값
	 * 		escapeseXml |	boolean		|	특수 문자를 반환할지의 여부
	 ...
	 * 		- 절대 URL : 완전한 URL이다.
	 * 		- 상대 URL :
	 * 			> 웹 어플리케이션 내에서의 절대 경로 : '/'로 시작하는경로 (ex_ /board/list.jsp)
