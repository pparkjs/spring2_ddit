...
public class AjaxMemberController {
	...
	public ResponseEntity<String> ajaxRegister03(
		// 비동기로 받을때는  자바빈즈를 매개변수로 받으려면 @RequestBody 어노테이션을 사용해서 그안에서 꺼내서 바인딩 할 수 있게 한다.
	...
	public ResponseEntity<String> register04(String userId){
		...
		// 요청 본문에서 데이터를 가져오려면 @RequestBody 어노테이션을 꼭 붙여주어야한다. ( ajax에서 보낸 data가 json형식 object일때는 String 이기떄문에 그게 스트링형식으로 들어오기에
		// stringify 에 userId만 넣어서 보낸다.
