...
public class HomeController {
	...
	// 반환 값이 home0202이므로 뷰(/home0202.jsp)를 가리킨다.
	...
	// '/'로 시작하면 웹 어프리케이션의 컨텍스트 경로에 영향을 받지 않는 절대 경로를 의미한다.
	 ...
	 * 
	 * > 무료 / 유료 이미지 다운로드 홈페이지를 사용해보면 이미지 미리보기 또는 미리보기 후 다운로드 할 수 있는 기능이 제공된다.
	...
	public ResponseEntity<byte[]> goHome1101(){
		...
		try {
			// 파일 경로를 나타내는 방법 2가지
			// 방법 1 ('\\')
//			in = new FileInputStream(D:\\A_TeachingMaterial\\6_JspSpring\\02.SPRING2\\chopa.jpg");
			// 방법2 ('/')
			in = new FileInputStream("D:/A_TeachingMaterial/6_JspSpring/02.SPRING2/chopa.jpg");
